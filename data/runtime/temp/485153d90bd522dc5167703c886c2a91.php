<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./application/admin/template/index/welcome.htm";i:1732860816;s:80:"/Users/alan/Projects/WWW/eyoucms/application/admin/template/public/theme_css.htm";i:1721637128;s:77:"/Users/alan/Projects/WWW/eyoucms/application/admin/template/public/footer.htm";i:1680508820;}*/ ?>
<!doctype html>
<html>
<head>
...
<?php if(empty($ddos_scan_last_time) || empty($system_explanation_welcome_2) || empty($system_explanation_welcome_3)): ?>
<div id="explanation_welcome" style="margin:10px 10px 0px 10px;">
    <?php if(empty($ddos_scan_last_time)): ?>
    <div class="explanation" style="color: rgb(44, 188, 163); background-color: #fff!important;  margin-top: 10px;">
        <ul>
            <li style="color: red;">
                温馨提示：升级完成！欢迎使用<?php echo $version; ?>，建议到安全中心给系统做一次安全检测，看看是否有安全隐患需要处理<a href="<?php echo url('Security/index'); ?>">【点击进入】</a>
            </li>
        </ul>
    </div>
    ...
    <?php endif; ?>
    <!-- <?php if(empty($system_explanation_welcome_3)): ?>
    <div class="explanation" style="color: rgb(44, 188, 163); background-color: #fff!important;  margin-top: 10px;">
        <div class="title checkZoom" data-type="2">
            <span title="不再提示" style="display: block;"></span>
        </div>
        <ul>
            <li style="color: red;">
                <?php if(empty($ddos_scan_last_time)): ?>
                    您的网站还没定期检查
                <?php else: ?>
                    您的网站已有<?php echo $ddos_scan_expire_day; ?>天没有定期检查
                <?php endif; ?>
                ，请进入<a href="<?php echo url('Security/index'); ?>">【安全中心】</a>立即扫描。
            </li>
        </ul>
    </div>
    <?php endif; ?> -->
                        ...
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php if(!(empty($is_eyou_authortoken) || (($is_eyou_authortoken instanceof \think\Collection || $is_eyou_authortoken instanceof \think\Paginator ) && $is_eyou_authortoken->isEmpty()))): ?><a href="https://www.eyoucms.com/buy/" target="_blank" style="color: #454545;">盗版必究</a><?php else: ?>正版软件<?php endif; ?>&nbsp;<a href="javascript:void(0);" onclick="top.openItem('Index|authortoken|is_force|1');">校验</a></td>
                                </tr>
